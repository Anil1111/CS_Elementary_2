...
namespace Contacts
{
    class WorkWithMySql : WorkWithData
    {
        ...
        public override /*List<FieldTable>*/ DataTable SearchRecord(string searchStr)
        {
        ...
        public override /*List<FieldTable>*/ DataTable SelectRecord(FieldTable tableField, string getViewTable)
        {
